...
------------------------------------------------------------------------- */
	...
	$g_builder_object = ((($g_continue_check)&&($g_source_path)) ? new directBuilder () : NULL);
...
------------------------------------------------------------------------- */
		...
		$g_builder_object->setExcludeFiles ("INSTALL,CHANGELOG,NEWS,FAQ,LICENSE,build.xml,data/settings/nim/swg_nim_runonce.xml");
		$g_builder_object->setStripPrefix ($g_source_path);
		$g_builder_object->setTargetMetadata ("basic","swg_basic",2,$g_swg_version,$g_swg_iversion);
