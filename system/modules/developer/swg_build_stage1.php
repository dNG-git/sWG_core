...
NOTE_END //n*/
/**
* developer/swg_build_stage1.php
*
...
echo ("
----------------------------------------------------------------------------
(C) $direct_settings[swg_title_txt] (Stage 1 Builder)
All rights reserved
----------------------------------------------------------------------------
This tool should be used by sWG core developers only. If you are not a core
developer, please download a sWG core package provided by the
direct Netware Group.
...
------------------------------------------------------------------------- */
	...
	if (file_exists ($direct_settings['path_data']."/settings/swg_build_targets{$g_profile}.php"))
	{
		...
		if ($g_file_data)
		{
			...
			{
				if (isset ($g_xml_node_array['swg_build_file_v1']/*#ifndef(PHP4) */,/* #*//*#ifdef(PHP4):) && isset (:#*/$g_xml_node_array['swg_build_file_v1']['stage1']/*#ifndef(PHP4) */,/* #*//*#ifdef(PHP4):) && isset (:#*/$g_xml_node_array['swg_build_file_v1']['stage1']['xml.item']['attributes']['swgversion']))
				{
					$g_xml_node_array = $g_xml_node_array['swg_build_file_v1']['stage1'];
