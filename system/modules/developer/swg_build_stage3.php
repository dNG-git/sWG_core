...
----------------------------------------------------------------------------
$Id: swg_build_stage3.php,v 1.7 2008/02/24 21:05:42 s4u Exp $
#echo(sWGcoreVersion)#
...
------------------------------------------------------------------------- */
	...
	if (($g_continue_check)&&($g_pdescriptor)&&($g_pname)&&($g_source_path)) { $g_builder_object = new direct_developer_builder (); }
