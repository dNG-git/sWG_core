...
------------------------------------------------------------------------- */
		...
		parent::__construct ("","","class,css,gif,ipd,jpg,js,php,png,swf,txt,xml",@$direct_settings['swg_umask_change'],@$direct_settings['swg_chmod_files_change'],@$direct_settings['swg_chmod_dirs_change'],$direct_cachedata['core_time'],($direct_settings['timeout'] + $direct_settings['timeout_core']),USE_debug_reporting);
