...
{
/**
* The following class implements the action parser for the command line.
*
* @author     direct Netware Group
* @copyright  (C) direct Netware Group - All rights reserved
* @package    sWG_core
...
*             W3C (R) Software License
*/
class directActionParserCmd extends directVirtualClass
{
/* -------------------------------------------------------------------------
...
/*#ifdef(PHP4):
/**
	* Constructor (PHP4) directActionParserCmd
	*
	* @since v0.1.01
*\/
	function directActionParserCmd () { $this->__construct (); }
:#*/
/**
	...
	/*#ifndef(PHP4) */public static /* #*/function ilineParse ($f_iline = NULL)
	{
		...
		if (!isset ($f_iline))
		{
			...
			elseif (count ($_SERVER['argv']))
			{
				...
				$f_iline = ((count ($_SERVER['argv']) > 1) ? $_SERVER['argv'][1] : "");
			}
		}
...
/**
* To extend correctly be sure to provide the action parser class.
*
* @author     direct Netware Group
* @copyright  (C) direct Netware Group - All rights reserved
* @package    sWG_core
...
*             W3C (R) Software License
*/
class directActionParser extends directActionParserCmd
{
/* -------------------------------------------------------------------------
...
define ("CLASS_directActionParserCmd",true);

//j// Script specific commands

global $direct_globals;
$direct_globals['@names']['basic_functions'] = 'dNG\sWG\directActionParserCmd';
}
