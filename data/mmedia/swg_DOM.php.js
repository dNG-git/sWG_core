...
function djs_swgDOM_insert_after (f_params)
{
	if ((typeof (f_params['data']) != 'undefined')&&(typeof (f_params['id']) != 'undefined'))
	{
		...
		if ((typeof (f_params['onInsert']) != 'undefined')&&(f_params.onInsert != null)) { djs_run (f_params.onInsert); }
		...
		else { f_jquery_object.fadeIn ('fast',function () { djs_run (f_params.onInserted); }); }
	}
}
...
function djs_swgDOM_replace_with ()
{
	...
	if (typeof (djs_var['swgDOM_replace_cache'][f_id]) != 'undefined')
	{
		...
		if (djs_var['swgDOM_replace_cache'][f_id]['onReplace'] != null) { djs_run (djs_var['swgDOM_replace_cache'][f_id]['onReplace']); }
		...
		else
		{
			...
			{
				djs_run (djs_var['swgDOM_replace_cache'][f_id]['onReplaced']);
				delete (djs_var['swgDOM_replace_cache'][f_id]);
			});
		}
	}
